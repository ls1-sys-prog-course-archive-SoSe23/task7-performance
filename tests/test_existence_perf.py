...
if not found:
    print("One of the events required is not found in the matrix files")
    sys.exit(1)

if not iteration:
    print("The number of iterations of the matrix program is not correct")
    sys.exit(1)
...
if not iteration:
    print("The number of iterations of the mandelbrot program is not correct")
    sys.exit(1)

if not found:
    print("One of the events required is not found in the mandelbrot files")
    sys.exit(1)
